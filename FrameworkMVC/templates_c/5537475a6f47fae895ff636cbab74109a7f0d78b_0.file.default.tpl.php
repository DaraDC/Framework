...
<form class="form-signin" align="center" method="post">
  ...
  <input  type="text" id="inputuser" class="form-control" placeholder="Username" required autofocus name="usuario">
  ...
  <input type="text" id="inputPuesto" class="form-control" placeholder="Puesto" required name="puesto">
